...
import { Users, Flag, Headset, ExternalLink } from "lucide-react";
import {
  Chart as ChartJS,
  CategoryScale,
  LinearScale,
    ...
    <>
      ...
      <section className="admin-cards-grid">
        <div className="info-card-admin">
          ...
          <p>
            12 educator applications waiting for verification. Average
        ...
        <div className="info-card-admin">
          ...
          <p>
            5 pieces of content flagged for review. Priority: 2 high, 3 medium.
          </p>
          <button className="btn-admin">
        ...
        <div className="info-card-admin">
          ...
          <p>
            3 open support tickets. 1 urgent, 2 normal priority. Average
