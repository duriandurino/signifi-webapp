...
const InstitutionDashboardPage = () => {
  ...
  useEffect(() => {
    setRecentCourses([
      { name: "Intro to FSL", event: "Published", date: new Date(Date.now() - 3600 * 1000 * 5), students: 120 },
      { name: "Sign Language for Educators", event: "Draft", date: new Date(Date.now() - 3600 * 1000 * 26), students: 0 },
      { name: "Inclusive Teaching Methods", event: "Published", date: new Date(Date.now() - 3600 * 1000 * 48), students: 85 },
    ]);

    setAnnouncements([
      { title: "Quarterly Compliance Report Due", message: "Submit your Q3 compliance documents by Sept 15.", date: new Date(Date.now() - 3600 * 1000 * 2) },
      { title: "New Policy Update", message: "Institution guidelines for course content have been updated.", date: new Date(Date.now() - 3600 * 1000 * 24) },
      { title: "Training Reminder", message: "Attend the workshop on inclusive teaching scheduled next week.", date: new Date(Date.now() - 3600 * 1000 * 72) },
    ]);
  }, []);
